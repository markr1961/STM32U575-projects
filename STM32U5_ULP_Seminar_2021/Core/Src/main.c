...
int main(void)
{
  ...
  MX_RTC_Init();
  /* USER CODE BEGIN 2 */
  /* Toggle ALl three LEDs for 3 seconds */
  for (int loop = 0; loop < 10; loop++)
  {
   ...
   /* Leave Blue LED2 On until entering Lower Power Mode */
...
static void MX_RAMCFG_Init(void)
{
  ...
  */
  ...
  if (HAL_RAMCFG_ConfigWaitState(&hramcfg_SRAM3, RAMCFG_WAITSTATE_1) != HAL_OK)
  {
    Error_Handler();
  }
  ...
  */
  ...
  if (HAL_RAMCFG_ConfigWaitState(&hramcfg_SRAM4, RAMCFG_WAITSTATE_1) != HAL_OK)
  {
    Error_Handler();
  }
...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  /*Configure GPIO pin : LED2_Blue_Pin */
  GPIO_InitStruct.Pin = LED2_Blue_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(LED2_Blue_GPIO_Port, &GPIO_InitStruct);
